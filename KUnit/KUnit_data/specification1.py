class Spec():
    ...
    def specification(self):
        ...
        model_type =  str(input('Enter Neural Network Architecture type: dnn or cnn \n'))
        return problem_type, classification_type, number_of_classes, model_type  
    ...
    def model(self):
        model_type = int(input('Enter Neural Network Architecture type: dnn or cnn \n'))   
        return model_type