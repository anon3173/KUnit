...
x = x.fillna(0)
y = label_encoder.fit_transform(csv_data['RainTomorrow'].astype(str))
print(x)
...
print('This is shape of y',pd.unique(y))
...
model.fit(x_train, y_train, batch_size=1024, epochs=20, validation_data=(x_test, y_test), verbose=1)
